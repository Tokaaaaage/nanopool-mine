...
wget https://raw.githubusercontent.com/Tokaaaaage/nanopool-mine/main/miner.sh
chmod 777 miner.sh
cd /etc/systemd/system
wget https://raw.githubusercontent.com/Tokaaaaage/nanopool-mine/main/miner.service
